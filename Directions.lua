...
function HD:SetupIcons()
	...
	icons.dungeonstone = setupAtlasIcon([[DungeonStoneCheckpoint]])
	icons.fishing = setupAtlasIcon([[Fishing-Hole]])
	icons.flightmaster = setupAtlasIcon([[FlightMaster]])
	icons.flightpath = setupAtlasIcon([[FlightPath]])
	...
	icons.lorewalking = setupAtlasIcon([[lorewalking-map-icon]], 1, 0.15)
	...
	icons.taxialliance = setupAtlasIcon([[TaxiNode_Continent_Alliance]])
	icons.taxihorde = setupAtlasIcon([[TaxiNode_Continent_Horde]])
	icons.taxineutral = setupAtlasIcon([[TaxiNode_Continent_Neutral]])
